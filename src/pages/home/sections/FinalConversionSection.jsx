...
import { trackPrimaryCtaClick, trackContactClick } from '../../../analytics/index.js';
    ...
    <div className="section-shell">
      <div className="final-cta-panel">
        <div className="final-cta-copy">
          ...
          <p>Grow your Amazon business with a clear plan for visibility, conversion and profitable sales. Bring us your priorities and let’s find your next opportunity.</p>
