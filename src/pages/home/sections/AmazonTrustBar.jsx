    ...
    <div className="section-shell">
      <details className="group">
        <summary className="flex min-h-12 cursor-pointer list-none flex-wrap items-center justify-between gap-3 rounded-lg [&::-webkit-details-marker]:hidden">
          <span className="flex items-center gap-3"><ShieldCheck className="h-6 w-6 shrink-0 text-primary-800" aria-hidden="true" /><span id="amazon-spn-heading" className="font-bold text-amazon-dark">Listed on Amazon’s Service Provider Network</span></span>
