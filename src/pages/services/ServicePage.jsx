    ...
    <MarketingLayout>
      <section className="bg-amazon-dark py-14 text-white md:py-20">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-10">
          ...
          <p className="mt-4 max-w-3xl leading-relaxed text-gray-300">
            <span className="font-extrabold text-white">Who it is for:</span> {service.whoItIsFor}
          </p>
          {service.spnServiceKey && (
            <div className="mt-7">
              <SpnServiceLinks serviceKey={service.spnServiceKey} dark />
            </div>
          )}
        </div>
      </section>
      ...
      <section className="bg-white py-14 md:py-20" aria-labelledby="service-problems-heading">
        <div className="mx-auto grid max-w-6xl gap-10 px-4 sm:px-6 lg:grid-cols-2 lg:px-10">
          ...
          <div>
            <h2 className="text-3xl font-black text-amazon-dark">Primary outcome</h2>
      ...
      <section className="bg-amazon-cream py-14 md:py-20" aria-labelledby="service-deliverables-heading">
        <div className="mx-auto grid max-w-6xl gap-10 px-4 sm:px-6 lg:grid-cols-2 lg:px-10">
          ...
          <div>
            <h2 className="text-3xl font-black text-amazon-dark">What we need from the client</h2>
        ...
        <div className="mx-auto mt-10 max-w-6xl px-4 sm:px-6 lg:px-10">
          <div className="rounded-2xl border border-gray-200 bg-white p-6 text-amazon-dark">
            <h2 className="text-xl font-black">A scope built around your account</h2>
            <p className="mt-3 leading-relaxed">
              Your written proposal sets out the services, reporting, fees, timelines and responsibilities for your engagement. Discuss your priorities with us to define the right scope.
            </p>
          </div>
        </div>
      </section>
